...
- [平台规格](/zh/dev/design/platform)：PersonaBot、记忆规则、状态与工作方式
- [应用 PRD](/zh/dev/design/app-prd)：DeepSeekBot 的用户故事与验收标准
- [领域词表](/zh/dev/design/context)：术语的规范用法（PersonaBot / Agent / Session / Workspace）
