...
- [Platform spec](/dev/design/platform): PersonaBot, memory rules, state, and how work happens
- [App PRD](/dev/design/app-prd): DeepSeekBot user stories and acceptance criteria
- [Domain glossary](/dev/design/context): canonical usage of terms (PersonaBot / Agent / Session / Workspace)
