window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		*/
		function createComputerSettingsFace(options) {
			...
			return {
				...
				exportArchive: async (dir) => {
					return (await requestJson$1(EXPORT_ENDPOINT, {
						method: "POST",
						headers: { "content-type": "application/json" },
		...
		function ComputerSettingsRows({ t, prefs, pickerAvailable, pickDirectory, openDirectory, exportArchive, importArchive, listArchives, hostExportDir }) {
			...
			const runExport = (0, react.useCallback)(() => {
				...
				setBusy("export");
				setNote(void 0);
				exportArchive(exportTarget).then((archive) => setNote(archive === "" ? t("rows.exportedDone") : t("rows.exported", { archive }))).catch((error) => setNote(String(error))).finally(() => setBusy(void 0));
			}, [
				exportArchive,
				exportTarget,
				t
			...
			const runImport = (0, react.useCallback)((file) => {
				...
				setBusy("import");
				setNote(void 0);
				importArchive(file).then(() => setNote(t("rows.imported", { file }))).catch((error) => setNote(String(error))).finally(() => setBusy(void 0));
			}, [importArchive, t]);
				...
				children: [
					/* @__PURE__ */ (0, react_jsx_runtime.jsx)(Row, {
						...
						children: /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
							...
							children: [
								pickerAvailable ? /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("button", {
									type: "button",
									className: "bh-settings-selector",
									disabled: !writable,
					...
					/* @__PURE__ */ (0, react_jsx_runtime.jsx)(Row, {
						...
						children: /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
							...
							children: [
								confirming === "export" ? /* @__PURE__ */ (0, react_jsx_runtime.jsxs)(react_jsx_runtime.Fragment, { children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)("button", {
									type: "button",
									className: "bh-settings-selector",
									onClick: () => {
										setConfirming(void 0);
									...
									onClick: startExport,
									children: busy === "export" ? t("rows.exporting") : pickerAvailable ? t("rows.exportTo") : t("rows.export")
								}),
								confirming === "import" ? /* @__PURE__ */ (0, react_jsx_runtime.jsx)("button", {
									type: "button",
									className: "bh-settings-selector",
									onClick: () => {
										setConfirming(void 0);
								...
								confirming === "import" && archives?.[0] !== void 0 ? /* @__PURE__ */ (0, react_jsx_runtime.jsx)("button", {
									type: "button",
									className: "bh-settings-selector",
									onClick: () => {
...
`;
		...
		*/
		...
		function ComputerEntryView(props) {
			const { t, state, phase, detail, progress, runtimeAvailable, confirming, busy, elapsed, nowTs, error, botSlug, onStart, onConfirmStart, onStop, onApprove, onCancel } = props;
