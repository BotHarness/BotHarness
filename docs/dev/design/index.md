...
- [BotHarness Product Context](/dev/design/context): the single authority for PersonaBot, Channel, Source Event, Bot Inbox, Orchestrator Session, Work Session, and other BotHarness terms, distinct from DSH and Cordis vocabulary.
