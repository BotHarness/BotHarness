...
> Superseded by ADR-0047, then ADR-0060: nothing is injected from Memory into the system prompt; the Agent explores its Memory Repository with ordinary file tools.
