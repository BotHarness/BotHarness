...
| 日期      | 2026-09-17                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                   |
| 状态      | Draft                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                        |
| 仓库      | `~/project/DeepSeekBot`（GitHub: `BotHarness/DeepSeekBot`）                                                                                                                                                                                                                                                                                                                                                                                                                                                                                  |
...
| v0.8 变更 | ① 添加 GitHub 远端 `BotHarness/DeepSeekBot`；② Issue 管理切换到 **GitHub Issues**（`gh` CLI；PR 不作 triage 入口）；③ 按 PRD 建立领域文档：根 `CONTEXT.md` + `docs/adr/`（10 篇，沉淀 §5.2 关键决策）                                                                                                                                                                                                                                                                                                                                        |
...
| M1     | **基座验证（Lark 国际版）+ 集成地基**（进行中，[#1](https://github.com/BotHarness/DeepSeekBot/issues/1)）：独立插件脚手架、session→bot 识别、设置分区、六条 gate（见下） | 待开始    |
...
- 技能初始化（对应 `setup-matt-pocock-skills`）：
  - Issue tracker：**GitHub Issues**（`BotHarness/DeepSeekBot`，`gh` CLI；PR 不作 triage 入口）——见 `docs/agents/issue-tracker.md`
